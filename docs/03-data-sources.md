...
| Aircraft (worldwide overview) | OpenSky Network `states/all`, fetched by the Worker cron every 15 minutes into R2 | About 13,000 aircraft, shown when zoomed out | Free for non-commercial use with attribution | "OpenSky Network" |
